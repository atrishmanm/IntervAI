...
def make_training_configs(env):
    ...
    return {
        ...
        "domain": {
            ...
            "betas": (0.9, 0.95), "max_epochs": 15, "batch_size": batch,
            "grad_clip": 1.0, "max_len": 1024, "grad_accum_steps": accum,
            "patience": 3, "min_delta": 0.005, "ckpt_every": 1000, "lr_finder": True,
            "ema_decay": 0.95, "label_smoothing": 0.03,
            "schedule": "cosine", "stable_pct": 0.80, "decay_pct": 0.18,
        ...
        "evaluator": {
            "lr": 1e-4, "warmup_ratio": 0.05, "weight_decay": 0.03,
            "betas": (0.9, 0.99), "max_epochs": 10, "batch_size": batch,
            "grad_clip": 1.0, "max_len": 1024, "grad_accum_steps": accum,
            "patience": 3, "min_delta": 0.005, "ckpt_every": 500, "lr_finder": True,
            "ema_decay": 0.95, "label_smoothing": 0.05,
            "schedule": "cosine", "stable_pct": 0.70, "decay_pct": 0.25,
            "gradient_checkpointing": True,
            "optimizer": "muon", "muon_momentum": 0.95,
            "sequence_packing": True, "torch_compile": True,
        ...
        "resume_finetune": {
            ...
            "betas": (0.9, 0.99), "max_epochs": 10, "batch_size": batch,
            "grad_clip": 1.0, "max_len": 1024, "grad_accum_steps": accum,
            "patience": 3, "min_delta": 0.003, "ckpt_every": 500, "lr_finder": False,
