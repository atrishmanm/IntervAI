...
from tokenizers.normalizers import Sequence as NormSequence, Strip
...
def train(corpus_path: Path) -> Tokenizer:
    ...
    # Normalizer: strip + lowercase
    tokenizer.normalizer = NormSequence([Strip()])  # Case-sensitive for code
